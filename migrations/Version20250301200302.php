 ...
 */
final class Version20250301200302 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE goal (id INT AUTO_INCREMENT NOT NULL, product_id INT NOT NULL, veterinary_id INT NOT NULL, amount NUMERIC(12, 2) NOT NULL, year INT NOT NULL, INDEX IDX_FCDCEB2E4584665A (product_id), INDEX IDX_FCDCEB2ED954EB99 (veterinary_id), UNIQUE INDEX UQ_Goal (veterinary_id, product_id, year), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, price NUMERIC(10, 2) NOT NULL, date DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE veterinary (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, name VARCHAR(100) NOT NULL, address VARCHAR(50) NOT NULL, postal_code VARCHAR(5) NOT NULL, city VARCHAR(255) NOT NULL, phonep VARCHAR(25) NOT NULL, image_file_name VARCHAR(100) NOT NULL, creation_date DATETIME NOT NULL, INDEX IDX_8B49EF5712469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
