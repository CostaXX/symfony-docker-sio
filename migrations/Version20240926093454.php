 ...
 */
final class Version20240926093454 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE goal (id INT AUTO_INCREMENT NOT NULL, product_id INT NOT NULL, veterinary_id INT NOT NULL, amount NUMERIC(12, 2) NOT NULL, INDEX IDX_FCDCEB2E4584665A (product_id), INDEX IDX_FCDCEB2ED954EB99 (veterinary_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
